/**
 * svelte-ratatui Plugin Installation Script
 */
...
export default async function install(projectDir) {
  ...
  console.log('✅ svelte-ratatui plugin installed successfully');
  console.log('   Run "npm install" to install @plures/svelte-ratatui@^' + manifest.version);
  console.log('   Ensure tauri-plugin-tui is added to your Cargo.toml dependencies');
}
